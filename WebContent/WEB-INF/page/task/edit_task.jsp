...
<div class="modal fade" id="editTask" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form class="update-task-form">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="degree">
                <option class="degree1" value="1">普通</option>
                <option class="degree2" value="2">紧急</option>
                <option class="degree3" value="3">非常紧急</option>
            </select>
          </div>
          <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary update-task-button" data-dismiss="modal">保存</button>
      </div>
    </div>
  </div>
</div>